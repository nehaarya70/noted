...
?>
 ...
 <?php
        ...
        $id=$_GET['approve'];
        $approve_query = "UPDATE complaints SET status='solved' WHERE id='$id'";
	...
	<div class="container">
		...
		<div class="col-md-8 offset-2">
			...
			<?php
				...
				$query = "SELECT * FROM complaints  WHERE status='not solved yet' ORDER BY date DESC";
			...
			<div class="row">
				...
				<div class="col-md-4" >
					...
					<a onClick=\"javascript: return confirm('Are you sure you want to approve this note?')\" href='?approve=<?php echo $id ?>' class="btn-success btn-sm text" style="font-size:15px;float:right;">
